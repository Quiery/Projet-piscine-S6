...
<div class="container" style="text-align: center;" id="CompteAdmin">
    ...
    <button type="button" id="button_admin" href="#">Mes articles en ventes</button><br>
    <button type="button" id="button_admin" href="#">Ajouter un vendeur</button><br>
    <button type="button" id="button_admin" href="#">Supprimer un vendeur</button>
</div>
